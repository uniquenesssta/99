    ...
    <div className="app">
      ...
      >
        <FontListPanel
          ...
          activateFontsBatch={content.activateFontsBatch}
          deactivateFontsBatch={content.deactivateFontsBatch}
          deleteFontsBatch={content.deleteFontsBatch}
          uninstallFontsBatch={content.uninstallFontsBatch}
          toggleFontDeleteProtection={content.toggleFontDeleteProtection}
        ...
        <FontDetailPanel
          ...
          toggleFontFavorite={detail.toggleFontFavorite}
          installSelected={detail.installSelected}
          removeSelected={detail.removeSelected}
          activateSelected={detail.activateSelected}
          deactivateSelected={detail.deactivateSelected}
          toggleFontDeleteProtection={detail.toggleFontDeleteProtection}
      ...
      <AppOverlays
        ...
        selectionLabel={overlays.selectionLabel}
        runFontContextAction={overlays.runFontContextAction}
        deleteFontsBatch={overlays.deleteFontsBatch}
        uninstallFontsBatch={overlays.uninstallFontsBatch}
        toggleFontDeleteProtection={overlays.toggleFontDeleteProtection}
