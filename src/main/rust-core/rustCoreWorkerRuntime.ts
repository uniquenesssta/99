...
export function createRustCoreWorkerRuntime(options: RustCoreWorkerRuntimeOptions) {
  ...
  const { runRustInstallStatusRead, runRustInstallStatusSave, runRustInstallStatusCompare, runRustLocalTagsRead, runRustLocalTagsSet, runRustLocalTagsDeleteTag, runRustSharedMetadataApply, runRustSharedMetadataRemoveTag, runRustSharedMetadataKnownTags, runRustSharedMetadataOverlayRead, runRustSharedMetadataSignature } = createRustMetadataClientRuntime({
