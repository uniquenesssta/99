...
const api = {
  ...
  setSharedTags: (items, watchedFolders, tagNames, trace) => invoke('fonts:setSharedTags', items, watchedFolders, tagNames, ...(trace ? [{ __hfmOperationTrace: trace }] : [])),
  setSharedTagsBatch: (items, watchedFolders, trace) => invoke('fonts:setSharedTagsBatch', items, watchedFolders, ...(trace ? [{ __hfmOperationTrace: trace }] : [])),
  renameSharedTag: (oldTagName, newTagName, watchedFolders, trace) => invoke('fonts:renameSharedTag', oldTagName, newTagName, watchedFolders, ...(trace ? [{ __hfmOperationTrace: trace }] : [])),
  deleteSharedTag: (tagName, watchedFolders, trace) => invoke('fonts:deleteSharedTag', tagName, watchedFolders, ...(trace ? [{ __hfmOperationTrace: trace }] : [])),
  activateFont: (item) => invoke('fonts:activateFont', item),
  activateFonts: (items, trace) => invoke('fonts:activateFonts', items, ...(trace ? [{ __hfmOperationTrace: trace }] : [])),
  ...
  getPreviewBackend: () => invoke('fonts:getPreviewBackend'),
  cancelPreviewImage: (token) => invoke('fonts:cancelPreviewImage', token),
  renderPreviewImage: (item, text, fontSize, width, height, token) => invoke('fonts:renderPreviewImage', item, text, fontSize, width, height, ...(token ? [token] : [])),
