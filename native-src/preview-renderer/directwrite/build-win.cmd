...
cl /nologo /EHsc /std:c++17 /utf-8 /W4 /O2 /DUNICODE /D_UNICODE /DNOMINMAX /D_WIN32_WINNT=0x0A00 cli.cpp preview.cpp resident.cpp fontCache.cpp localFontFile.cpp memoryBudget.cpp /Fo"..\..\..\build\native\directwrite\\" /Fe"..\..\..\build\native\directwrite\hfm-directwrite-preview.exe" /link dwrite.lib d2d1.lib windowscodecs.lib ole32.lib bcrypt.lib psapi.lib
exit /b %errorlevel%
