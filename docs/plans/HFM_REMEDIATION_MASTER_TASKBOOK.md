...
> 2026-09-26 当前入口：[Stage 10 预览性能任务书](HFM_STAGE_10_PREVIEW_PERFORMANCE_TASKBOOK.md)。用户停止 DW 试验推进，从 Stage 9 创建 `stage/10-preview-performance`；S10-00 独立回移已完成，审计及 S10-01 至 06 执行卡已补齐（第 7–10 节）；S10-01 已实现复现与关联观测（验证状态见第 11 节），S10-02 已实现优先级提升与可见卡片补排（验证状态见第 12 节），S10-03 已实现结果分类与有界恢复（见第 13 节），S10-04 已实现缓存关键路径与共享准备分离，验证状态及 S10-03 CI 补正见第 14 节；下一实施项 S10-05，物理过期工作与实机验收仍开放。DW 分支保留，不整分支合并。
