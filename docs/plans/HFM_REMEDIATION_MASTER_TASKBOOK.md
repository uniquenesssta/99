...
> 新专项（仅规划、未实施）：[共享离线保留与本地字体退出清理任务书](HFM_SHARED_OFFLINE_LOCAL_EXIT_TASKBOOK.md)。按用户最终要求保留并置灰离线共享目录/标签，恢复后校验启用；本地副本取消与退出不依赖网络，不建设离线同步系统。O-00～O-08 未开始，旧 U-09 与 Windows 待验项保持。
